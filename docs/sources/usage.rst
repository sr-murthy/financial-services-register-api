...
The API client class is :py:class:`~fs_register_api_client.api.FSRegisterApiClient`. Import it, and create an instance using the signup email, which is the API username, and the API key:

.. code:: python

   >>> from fs_register_api_client.api import FSRegisterApiClient
   >>> client = FSRegisterApiClient('<signup email>', '<API key>')
   >>> client
   <fs_register_api_client.api.FSRegisterApiClient at 0x113c10800>

Each client instance maintains its own API session state (:py:class:`~fs_register_api_client.api.FSRegisterApiSession`):

.. code:: python

   >>> client.api_session
   <fs_register_api_client.api.FSRegisterApiSession at 0x113392060>
...
Almost all public client methods return :py:class:`~fs_register_api_client.api.FSRegisterApiResponse` objects, which have four properties specific to the FS Register API:

- :py:attr:`~fs_register_api_client.api.FSRegisterApiResponse.fs_register_status` - an FS Register-specific status indicator for the
  request
- :py:attr:`~fs_register_api_client.api.FSRegisterApiResponse.fs_register_message` - an FS Register-specific status message for the
  request
- :py:attr:`~fs_register_api_client.api.FSRegisterApiResponse.fs_register_data` - the response data
- :py:attr:`~fs_register_api_client.api.FSRegisterApiResponse.fs_register_resultinfo` - pagination information for the response data

As :py:class:`~fs_register_api_client.api.FSRegisterApiResponse` is a subclass of :py:class:`requests.Response`, request information can be obtained from the :py:attr:`requests.Response.request` attribute, e.g.
...
The common search endpoint can be used via the :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.common_search()` method to make generic queries for firms, individuals, or funds. It requires two arguments, a resource name (or name substring) to search for, and a resource type which must be one of the following strings: ``"firm"``, ``"individual"``, or ``"fund"``. The method then calls the common search endpoint with a URL-encoded string of the form below:
...
.. code:: python
   ...
   >>> res.fs_register_status
   'FSR-API-04-01-00'
   >>> res.fs_register_message
   'Ok. Search successful'
   >>> res.fs_register_resultinfo
...
.. code:: python
   ...
   >>> client.common_search('revolut bank', firm').fs_register_data
   ...
   #
   >>> client.common_search('mark carney', 'individual').fs_register_data
   [{'URL': 'https://register.fca.org.uk/services/V0.1/Individuals/MXC29012',
     ...
     'Name': 'Mark Carney'}]
   #
   >>> client.common_search('jupiter asia pacific income', 'fund').fs_register_data
...
The response data as stored in the :py:attr:`~fs_register_api_client.api.FSRegisterApiResponse.fs_register_data` property might be non-empty or empty depending on whether the combination of query and resource type is valid, e.g.:

.. code:: python

   >>> client.common_search('natwest', 'individual').fs_register_data
   # Null
...
The client implements a `regulated markets <https://www.handbook.fca.org.uk/handbook/glossary/G978.html?date=2007-01-20>`_ search endpoint via the :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_regulated_markets` method:

.. code:: python

   >>> c.get_regulated_markets().fs_register_data
...
- :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.search_frn()` - case-insensitive search for FRNs
- :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.search_irn()` - case-insensitive search for IRNs
- :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.search_prn()` - case-insensitive search for PRNs

All three methods trigger an :py:class:`~fs_register_api_client.exceptions.FSRegisterApiResponseException` in case of non-unique, multiple results, or no data.
...
Imprecise names in the search can produce multiple records, and will trigger an :py:class:`~fs_register_api_client.exceptions.FSRegisterApiResponseException` indicating the problem, e.g.:
...
.. code:: python
   ...
   ...
   fs_register_api_client.api.FSRegisterApiResponseException: Multiple firms returned. Firm name needs to be more precise. If you are unsure of the results please use the common search endpoint
...
.. code:: python
   ...
   >>> client.common_search(urlencode({'q': 'hiscox', 'type': 'firm'})).fs_register_data
...
Searches for non-existent firms will trigger an :py:class:`~fs_register_api_client.exceptions.FSRegisterApiResponseException` indicating that no data found in the FS Register for the given name:
...
.. code:: python
   ...
   Traceback (most recent call last):
   ...
   fs_register_api_client.api.FSRegisterApiResponseException: No data found in FSR API response. Please check the search parameters and try again.
...
.. code:: python
   ...
   Traceback (most recent call last):
   ...
   fs_register_api_client.api.FSRegisterApiResponseException: Multiple individuals returned. The individual name needs to be more precise. If you are unsure of the results please use the common search endpoint
   #
...
.. code:: python
   ...
   Traceback (most recent call last):
   ...
   fs_register_api_client.api.FSRegisterApiResponseException: Multiple funds returned. The fund name needs to be more precise. If you are unsure of the results please use the common search endpoint
   #
...
.. list-table::
   ...
   * - Method
     ...
     - Resource Parameters
     - Return
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm()`
     - ``/V0.1/Firm/{FRN}``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_addresses()`
     - ``/V0.1/Firm/{FRN}/Address``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_appointed_representatives()`
     - ``/V0.1/Firm/{FRN}/AR``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_controlled_functions()`
     - ``/V0.1/Firm/{FRN}/CF``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_disciplinary_history()`
     - ``/V0.1/Firm/{FRN}/DisciplinaryHistory``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_exclusions()`
     - ``/V0.1/Firm/{FRN}/Exclusions``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_individuals()`
     - ``/V0.1/Firm/{FRN}/Individuals``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_names()`
     - ``/V0.1/Firm/{FRN}/Names``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_passports()`
     - ``/V0.1/Firm/{FRN}/Passports``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_passport_permissions()`
     - ``/V0.1/Firm/{FRN}/Passports/{Country}/Permission``
     - ``GET``
     - FRN (str), Country (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_permissions()`
     - ``/V0.1/Firm/{FRN}/Permissions``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_regulators()`
     - ``/V0.1/Firm/{FRN}/Regulators``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_requirements()`
     - ``/V0.1/Firm/{FRN}/Requirements``
     - ``GET``
     - FRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_requirement_investment_types()`
     - ``/V0.1/Firm/{FRN}/Requirements/{ReqRef}/InvestmentTypes``
     - ``GET``
     - FRN (str), Requirement Reference (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_firm_waivers()`
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - firm details
      ...
      .. code:: python
         ...
         >>> client.get_firm('122702').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - addresses
      ...
      .. code:: python
         ...
         >>> client.get_firm_addresses('122702').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - controlled functions
      ...
      .. code:: python
         ...
         >>> client.get_firm_controlled_functions('122702').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - disciplinary history
      ...
      .. code:: python
         ...
         >>> client.get_firm_disciplinary_history('122702').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - exclusions
      ...
      .. code:: python
         ...
         >>> client.get_firm_exclusions('122702').fs_register_data
         ...
         #
         >>> client.get_firm_individuals('122702').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - alternative or secondary trading names
      ...
      .. code:: python
         ...
         >>> client.get_firm_names('122702').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - passports
      ...
      .. code:: python
         ...
         >>> client.get_firm_passports('122702').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - firm country-specific passport permissions and activities
      ...
      .. code:: python
         ...
         >>> client.get_firm_passport_permissions('122702', 'Gibraltar').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - permissions and activities
      ...
      .. code:: python
         ...
         >>> client.get_firm_permissions('122702').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - regulators
      ...
      .. code:: python
         ...
         >>> client.get_firm_regulators('122702').fs_register_data
         [{'Termination Date': '',
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - requirements
      ...
      .. code:: python
         ...
         >>> client.get_firm_requirements('122702').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - investment types associated with a specific firm requirement
      ...
      .. code:: python
         ...
         >>> client.get_firm_requirement_investment_types('122702', 'OR-0262545').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Barclays Bank (FRN #122702)** - waivers
      ...
      .. code:: python
         ...
         >>> client.get_firm_waivers('122702').fs_register_data
...
.. list-table::
   ...
   * - Method
     ...
     - Parameters
     - Return
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_individual()`
     - ``/V0.1/Individuals/{IRN}``
     - ``GET``
     - IRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_individual_controlled_functions()`
     - ``/V0.1/Individuals/{IRN}/CF``
     - ``GET``
     - IRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_individual_disciplinary_history()`
...
.. grid:: 1
   ...
   .. grid-item-card:: **Mark Carney (IRN #MXC29012)** - individual details
      ...
      .. code:: python
         ...
         >>> client.get_individual('MXC29012').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Mark Carney (IRN #MXC29012)** - controlled functions
      ...
      .. code:: python
         ...
         >>> client.get_individual_controlled_functions('MXC29012').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **Mark Carney (IRN #MXC29012)** - disciplinary history
      ...
      .. code:: python
         ...
         >>> client.get_individual_disciplinary_history('MXC29012').fs_register_data
         # None
...
.. list-table::
   ...
   * - Method
     ...
     - Parameters
     - Return
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_fund()`
     - ``/V0.1/CIS/{PRN}``
     - ``GET``
     - PRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_fund_names()`
     - ``/V0.1/CIS/{PRN}/Names``
     - ``GET``
     - PRN (str)
     - :py:class:`~fs_register_api_client.api.FSRegisterApiResponse`
   * - :py:meth:`~fs_register_api_client.api.FSRegisterApiClient.get_fund_subfunds()`
...
.. grid:: 1
   ...
   .. grid-item-card:: **abrdn Multi-Asset Fund (PRN #185045)** - fund details
      ...
      .. code:: python
         ...
         >>> client.get_fund('185045').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **abrdn Multi-Asset Fund (PRN #185045)** - alternative or secondary names
      ...
      .. code:: python
         ...
         >>> client.get_fund_names('185045').fs_register_data
...
.. grid:: 1
   ...
   .. grid-item-card:: **abrdn Multi-Asset Fund (PRN #185045)** - subfunds
      ...
      .. code:: python
         ...
         >>> client.get_fund_subfunds('185045').fs_register_data
